...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('./log/Qwen1.5-7B_result.log')
    ]
)
...
def main():
    ...
    parser.add_argument('--model_path', 
                      default='./model/Qwen1.5-7B_neijing_sft', 
                    #   default='./model/Qwen1.5-7B-Chat', 
                      help='Path to the pre-trained model')
    
    # Output file path
    parser.add_argument('--output_file', 
                      default='./result/Qwen1.5-7B_neijing_sft_results.jsonl',
                    #   default='./result/Qwen1.5-7B-Chat_results.jsonl',
                      help='Path to save the analysis results in JSONL format')
    
    # Data file path
    parser.add_argument('--data_file', 
                      default='./data/NeijingOmniDataset/annotation.json',
